    ...
    def __getitem__(self, idx):
        while True:
            ...
            try:
                ...
                D_path = os.path.join(hp.preprocessed_path, "alignment", "{}-ali-{}.npy".format(speaker, basename), )
                D = np.load(D_path)
                f0_path = os.path.join(hp.preprocessed_path, "f0", "{}-f0-{}.npy".format(speaker, basename), )
                f0 = np.load(f0_path)
