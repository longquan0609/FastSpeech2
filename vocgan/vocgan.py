...
class VocGan:
    def __init__(self, checkpoint, device = 'cuda:0', config = None, denoise = True):
        ...
        self.hp = hp
        self.model = ModifiedGenerator(hp.audio.n_mel_channels, hp.model.n_residual_layers, ratios = hp.model.generator_ratio, mult = hp.model.mult, out_band = hp.model.out_channels).to(device)
